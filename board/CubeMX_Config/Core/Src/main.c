...
//  HAL_ADCEx_Calibration_Start(&hadc3);
  ...
  // HAL_DAC_SetValue(&hdac, DAC_CHANNEL_1, DAC_ALIGN_12B_R, 2048 - 1); // 输出基准电压1.65v
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(LTE_RELOAD_GPIO_Port, LTE_RELOAD_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LORA_RELOAD_Pin|ETH_CFG_Pin|ETH_RST_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : Q18_Pin Q17_Pin Q16_Pin Q15_Pin */
  GPIO_InitStruct.Pin = Q18_Pin|Q17_Pin|Q16_Pin|Q15_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : Q14_Pin Q13_Pin Q12_Pin Q11_Pin
                           Q10_Pin Q9_Pin Q8_Pin Q7_Pin
                           LTE_RELOAD_Pin LORA_WAKEUP_Pin */
  GPIO_InitStruct.Pin = Q14_Pin|Q13_Pin|Q12_Pin|Q11_Pin
                          |Q10_Pin|Q9_Pin|Q8_Pin|Q7_Pin
                          |LTE_RELOAD_Pin|LORA_WAKEUP_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pins : Q6_Pin Q5_Pin Q4_Pin Q3_Pin */
  GPIO_InitStruct.Pin = Q6_Pin|Q5_Pin|Q4_Pin|Q3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : Q2_Pin Q1_Pin Q0_Pin */
  GPIO_InitStruct.Pin = Q2_Pin|Q1_Pin|Q0_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  ...
  /*Configure GPIO pins : LTE_NET_Pin LORA_STATUS_Pin */
  GPIO_InitStruct.Pin = LTE_NET_Pin|LORA_STATUS_Pin;
  ...
  /*Configure GPIO pin : LTE_LINK_Pin */
  GPIO_InitStruct.Pin = LTE_LINK_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(LTE_LINK_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : ETH_LINK_Pin */
  GPIO_InitStruct.Pin = ETH_LINK_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(ETH_LINK_GPIO_Port, &GPIO_InitStruct);
