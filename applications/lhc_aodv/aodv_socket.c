...
int wait_on_reboot, hello_qual_threshold, ratelimit;
...
void NS_CLASS aodv_socket_process_packet(AODV_msg *aodv_msg,
                                         int len,
                                         struct in_addr src,
                                         struct in_addr dst,
                                         int ttl,
...
void NS_CLASS aodv_socket_send(AODV_msg * aodv_msg, struct in_addr dst,
			       int len, unsigned char ttl, struct dev_info *dev)
{
//     int retval = 0;
//     struct timeval now;
//     /* Rate limit stuff: */
