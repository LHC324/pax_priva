...
RREQ *NS_CLASS rreq_create(unsigned char flags,
...
void NS_CLASS rreq_send(struct in_addr dest_addr,
						unsigned int dest_seqno,
						int ttl,
						unsigned char flags)
{
						   ...
						   unsigned int ifindex)
{
    ...
    unsigned int rreq_orig_seqno, rreq_dest_seqno;
    unsigned int rreq_id, rreq_new_hcnt, life;
...
NS_STATIC struct rreq_record *NS_CLASS rreq_record_insert(
	struct in_addr orig_addr,
	unsigned int rreq_id)
{
...
NS_STATIC struct rreq_record *NS_CLASS rreq_record_find(
	struct in_addr orig_addr,
	unsigned int rreq_id)
{
    list_t *pos;
